    ...
    return (
        ...
        <div className="skills">
            ...
            <p className="content">
                ...
                <Progress done="85" name="SPRING BOOT"/>
                <Progress done="85" name="MICRO SERVICES" />
                <Progress done="90" name="MY SQL" />
                <Progress done="85" name="REST APIS" />
                <Progress done="70" name="JAVA SCRIPT" />
